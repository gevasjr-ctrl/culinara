"""
Mac Miller — Culinara's Intelligence & Vision Agent
Daily briefing, anomaly detection, knowledge base, learning engine, predictions.
Equal peer. Sees the big picture, connects the dots.
"""
...
AGENT_NAME = "mac_miller"
REPORT_FILE = "mac_miller_briefing.md"
...
def run(
    ...
    print(f"  Running Mac Miller ({run_model}){'  [WEEKLY REVIEW]' if is_sunday() else ''}...")
    ...
    print(f"  Mac Miller briefing saved: {path}")
