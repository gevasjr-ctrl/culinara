"""
Margin Agent — Culinara's Cost & Pricing AI
Analyzes food costs, menu engineering, pricing, and waste.
"""
...
AGENT_NAME = "margin"
REPORT_FILE = "margin_report.md"
PROMPT_FILE = "margin_system.md"
...
def run(client=None, model="claude-haiku-4-5-20251001") -> dict:
    ...
    print(f"  Running Margin agent ({model})...")
    ...
    print(f"  Margin report saved: {path}")
