"""
Prep Agent — Culinara's Operations & Procurement AI
Manages prep planning, inventory, ordering, invoices, and yield.
"""
...
def run(client=None, model="claude-haiku-4-5-20251001", margin_report: str = "") -> dict:
    ...
    print(f"  Running Prep agent ({model})...")
    ...
    print(f"  Prep report saved: {path}")
